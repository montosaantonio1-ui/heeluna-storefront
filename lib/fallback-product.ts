...
export const fallbackProduct: Product = {
  ...
  images: [
    ...
    { url: "/images/product-context-1.png", altText: "Heeluna Pro on a linen cloth with a terracotta bowl", width: 1254, height: 1254 },
    ...
    { url: "/images/roller-refills-infographic-1.png", altText: "Heeluna Pro roller guide: extra coarse for tough calluses, regular for dead skin, gentle for daily maintenance", width: 1254, height: 1254 },
    { url: "/images/led-indicator-1.png", altText: "Heeluna Pro built-in LED light illuminating the roller area, doubling as a power indicator", width: 1672, height: 941 },
    { url: "/images/pedicure-steps-1.png", altText: "Heeluna Pro 3-step pedicure ritual: choose the roller, buff, moisturize", width: 1254, height: 1254 },
  ...
  variants: [
    {
      ...
      image: { url: "/images/product-packshot-1.png", altText: "Heeluna Pro, White", width: 1024, height: 1536 },
    },
  ],
};
